    ...
    \subsection{Progress report (date): }
     ...
     \subsection{Progress report (date): }
      ...
      \begin{itemize}
        ...
        \item Scanning studies abstract and title based on Inclusion and Exclusion criteria - In Progress 
        \item Scanning introduction and conclusion parts of the studies based on Inclusion and Exclusion criteria (this was the phase in which we removed non-English studies)
