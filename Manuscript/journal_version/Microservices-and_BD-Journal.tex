...
\paragraph{Problem}
How should the team optimize for read workloads? how should the team optimize for the write workloads? can the data store be optimized for both read and write workloads? 
