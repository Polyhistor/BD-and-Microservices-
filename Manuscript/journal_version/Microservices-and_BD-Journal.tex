...
\begin{enumerate}
  ...
  \item the keywords searched are: ("Document Title":big data) AND ("Document Title":reference architecture) OR ("Document Title":big data architecture)
\end{enumerate}
...
%   \caption{BD RAs}
%   \label{table:bdRAs}
%   \begin{tabular}{|p{0.4cm}|p{12cm}|p{1.2cm}|p{0.5cm}|}
%   \hline
