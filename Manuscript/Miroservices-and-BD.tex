...
\begin{center}
    ...
    \begin{tabular}{ | m{2cm} | m{5cm} |  m{5cm} |}
        ...
        Vol-1 &  Database per Service, Event Sourcing, Command and Query Responsibility Segregation, External configuration store  & Reasoning, API gateway, Anti-Corruption Layer, Service Discovery, Self Registration, Priority Queue, 
 
        \\

        \hline

        Vol-1 &  Event Sourcing  & Reasoning
