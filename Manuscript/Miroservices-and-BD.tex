...
\begin{enumerate}
    ...
    \item Externalized configuration \checkmark
...
\begin{center}
    ...
    \begin{tabular}{ | m{3cm} | m{12cm} | }
        ...
        Platform and Infrastructure & Multiple service instances per host, Externalized configuration, Sidecar
 
        \\

        \hline

        Communicational & API gateway,  Anti-corruption layer, Self Registration, Service Discovery, Competing consumers, Pipes and filters, Priority queue, Ambassador, Gateway aggregate, Gateway offloading 
