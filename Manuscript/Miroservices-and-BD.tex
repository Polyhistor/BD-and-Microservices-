...
\begin{center}
    ...
    \begin{tabular}{ | m{2cm} | m{8cm} |  m{2cm} |}
        ...
        Database per Service, API Gateway, Gateway Routing, 
        ...
        API Gateway, Gateway Routing, Gateway Offloading, Gateway Aggregate & 
...
\begin{center}
    ...
    \begin{tabular}{ | m{2cm} | m{8cm} |  m{2cm} |}
        ...
        Event Sourcing, Command and Query Responsibility Segregation, Priority Queue, Leader Election, Bulkhead Pattern, 
        ...
        Event Sourcing, Command and Query Responsibility Segregation, API gateway, Gateway aggregate, Gateway offloading, Gateway routing, Priority queue,
        ...
        API gateway, Anti-corruption layer, Service Discovery, Gateway aggregate, Gateway routing, Backend for Frontend
        ...
        Event Sourcing, Command and Query Responsibility Segregation, Backend for Frontend, 
        ...
        External Configuration Store, API Gateway, Gateway Aggregate, Backend for Frontend 
